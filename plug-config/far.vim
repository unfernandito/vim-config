...
let g:far#file_mask_favorites=['%:p', '**/*.*', '**/*.js', '**/.jsx', '**/*.ts', '**/*.tsx', '**/*.py', '**/*.java', '**/*.css', '**/*.html', '**/*.vim', '**/*.cpp', '**/*.c', '**/*.h', ]
...
" t v_t   - Tggle item exclusion under the cursor.
...
" test save
" q v_q   - Close searching result buffer and its preview buffer (if exists)o
